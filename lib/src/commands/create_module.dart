...
import 'package:mago_merlino/src/template/bundle/flutterModuleBundle.dart';
...
class CreateModule extends Command<int> {
  CreateModule({
    Logger logger,
    ...
    argParser.addOption(
      'project-name',
      help: 'The project name for this new Flutter module. '
          'This must be a valid dart package name.',
    );
    argParser.addFlag(
      'path',
      abbr: 'p',
      help: 'The path directory name for this new Flutter module. ',
    );
  }
  ...
  @override
  String get invocation => 'mago_merlino create-module <output directory>';
  ...
  Future<int> run() async {
    ...
    final generator = await _generator(flutterModuleBundle);
